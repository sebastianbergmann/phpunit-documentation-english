...
- :ref:`requireCoverageMetadataOnSmallTests <appendixes.xml-configuration-file.phpunit.requireCoverageMetadataOnSmallTests>` (default: the value of ``requireCoverageMetadata``)
- :ref:`requireCoverageMetadataOnMediumTests <appendixes.xml-configuration-file.phpunit.requireCoverageMetadataOnMediumTests>` (default: the value of ``requireCoverageMetadata``)
- :ref:`requireCoverageMetadataOnLargeTests <appendixes.xml-configuration-file.phpunit.requireCoverageMetadataOnLargeTests>` (default: the value of ``requireCoverageMetadata``)
